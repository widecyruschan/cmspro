<?php
   ...
   * @copyright 2021
   * @version $Id: header.tpl.php, v1.00 2021-05-05 10:12:05 gewa Exp $
   */
  define("_WOJO", true);
  include ('init.php');
...
<main>
  <div class="wojo-grid">
    <div class="row fullsize align middle center">
      <div class="columns screen-80 tablet-100 mobile-100 phone-100">
        ...
        <h2 class="center aligned phone-hide"><?php echo Lang::$word->FRT_MTNC_TITLE;?></h2>
        <div class="center aligned"><?php echo Url::out_url(App::Core()->offline_msg);?></div>
...
<p id="mfooter">Copyright &copy;<?php echo date('Y') . ' '. App::Core()->company;?> Powered by <a href="http://tag.digital" target="_blank">tag.digital Limited</a></p>
