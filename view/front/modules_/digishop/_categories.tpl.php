...
<div class="row gutters align middle">
  ...
  <div class="columns auto phone-100">
    ...
    <a <?php if(!Validator::isGetSet("mode", "list")) echo 'href="' . Url::url(Router::$path, Url::buildUrl("mode","list")) . '"';?> class="wojo small icon button<?php if(Validator::isGetSet("mode", "list")) echo ' primary passive';?>"><i class="icon unordered list"></i></a>
  </div>
</div>
<?php if($this->rows):?>
