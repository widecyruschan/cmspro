  ...
  <div class="row gutters">
    <div class="columns screen-50 tablet-100 mobile-100 phone-100">
      ...
      <div class="wojo carousel" data-wcarousel='{"items":1,"nav":false,"dots":true}'>
        <a href="<?php echo FMODULEURL . Digishop::DIGIDATA . $this->row->id. '/' . $this->row->thumb;?>" data-gallery="digishop" class="lightbox"><img src="<?php echo Digishop::hasThumb($this->row->thumb, $this->row->id);?>" alt=""></a>
        <?php foreach($this->images as $img):?>
        <a href="<?php echo FMODULEURL . Digishop::DIGIDATA . $this->row->id. '/' . $img->name;?>" data-gallery="digishop" class="lightbox"><img src="<?php echo Digishop::hasThumb($img->name, $this->row->id);?>" alt="" class="wojo image"></a>
        <?php endforeach;?>
      </div>
      <?php else:?>
    ...
    <div class="columns screen-50 tablet-100 mobile-100 phone-100">
      <p class="wojo big thin text"><?php echo Utility::formatMoney($this->row->price);?></p>
      ...
      <?php include(FMODPATH . 'digishop/snippets/_singleButton.tpl.php');?>
    </div>
  </div>
</div>
