<?php
   ...
   * @copyright 2020
   * @version $Id: _categories.tpl.php, v1.00 2020-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row gutters align middle">
  ...
  <div class="columns auto phone-100">
    <div class="wojo filter buttons">
      <a <?php if(Validator::isGetSet("mode", "list")) echo 'href="' . Url::url(Router::$path, Url::buildUrl("mode","grid")) . '"';?> class="wojo small icon button<?php if(!Validator::isGetSet("mode", "list")) echo ' passive';?>"><i class="icon grid"></i></a>
      <a <?php if(!Validator::isGetSet("mode", "list")) echo 'href="' . Url::url(Router::$path, Url::buildUrl("mode","list")) . '"';?> class="wojo small icon button<?php if(Validator::isGetSet("mode", "list")) echo ' passive';?>"><i class="icon unordered list"></i></a>
    </div>
  </div>
</div>
<?php if($this->rows):?>
