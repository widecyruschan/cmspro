...
<table style="padding-top:25px">
  ...
  <tr>
    ...
    <td valign="top" style="width:20%">Amount Due:<br />
      Due Date:</td>
    <td valign="top" style="width:20%"><?php echo Utility::formatMoney($this->totals->grand, $this->totals->currency);?><br />
...
<table class="balance">
  ...
  <tr>
    ...
    <td><span><?php echo Utility::formatMoney($this->totals->grand, $this->totals->currency);?></span></td>
  </tr>
  <tr>
    <th>Status</th>
