  ...
  <div class="wojo basic card">
    <div class="row">
      <div class="columns flex fcolumn screen-40 phone-100">
        <img src="<?php echo Digishop::hasThumb($row->thumb, $row->id);?>" alt="<?php echo $row->title;?>"  class="wojo rounded fit image">
      </div>
      <div class="columns big full padding phone-100">
        ...
        <?php include(FMODPATH . 'digishop/themes/laguna/snippets/_listButton.tpl.php');?>
      </div>
    </div>
  </div>
  <?php endforeach;?>
