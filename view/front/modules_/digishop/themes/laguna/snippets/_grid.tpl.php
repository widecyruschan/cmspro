...
<div id="digishop" class="wojo mason <?php echo utility::numberToWords($this->conf->cols);?>" action="<?php echo FMODULEURL;?>">
  ...
  <div class="item">
    <div class="wojo attached basic card">
      ...
      <div class="content">
        <h6><a href="<?php echo Url::url('/' . $this->core->modname['digishop'], $row->slug);?>" class="black">
          <?php echo $row->title;?>
          </a>
        </h6>
        <small>
      ...
      <div class="footer">
        <?php include(FMODPATH . 'digishop/themes/laguna/snippets/_gridButton.tpl.php');?>
      </div>
    </div>
  </div>
  <?php endforeach;?>
