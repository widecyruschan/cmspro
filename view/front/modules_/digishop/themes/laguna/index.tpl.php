...
<?php include(FMODPATH . 'digishop/themes/laguna/_categories.tpl.php');?>
<?php break;?>
<?php case 2: ?>
<?php if($this->segments[1] == $this->core->modname['digishop-checkout']):?>
<!-- Start Digishop Checkout -->
<?php include(FMODPATH . 'digishop/themes/laguna/_checkout.tpl.php');?>
<?php else:?>
<!-- Start Digishop Item -->
<?php include(FMODPATH . 'digishop/themes/laguna/_item.tpl.php');?>
<?php endif;?>
<?php break;?>
...
<div class="row gutters align middle">
  <div class="columns phone-100">
    <div class="wojo divided horizontal list">
      ...
      <a href="<?php echo Url::url(Router::$path, Url::buildUrl("order","memberships|DESC"));?>" class="item<?php echo Url::setActive("order", "memberships");?>">
      <?php echo Lang::$word->MEMBERSHIP;?>
      </a>
      <a href="<?php echo Url::url(Router::$path, Url::buildUrl("order","category_id|DESC"));?>" class="item<?php echo Url::setActive("order", "category_id");?>">
  ...
  <div class="columns auto phone-100">
    <div class="wojo filter buttons">
      <a <?php if(Validator::isGetSet("mode", "list")) echo 'href="' . Url::url(Router::$path, Url::buildUrl("mode","grid")) . '"';?> class="wojo small icon button<?php if(!Validator::isGetSet("mode", "list")) echo ' passive';?>">
      <i class="icon grid"></i>
      </a>
      <a <?php if(!Validator::isGetSet("mode", "list")) echo 'href="' . Url::url(Router::$path, Url::buildUrl("mode","list")) . '"';?> class="wojo small icon button<?php if(Validator::isGetSet("mode", "list")) echo ' passive';?>">
...
<?php include(FMODPATH . 'digishop/themes/laguna/snippets/_list.tpl.php');?>
<?php else:?>
<?php include(FMODPATH . 'digishop/themes/laguna/snippets/_grid.tpl.php');?>
<?php endif;?>
<?php endif;?>
<div class="row gutters align middle">
