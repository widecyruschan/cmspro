...
<div id="digishop" action="<?php echo FMODULEURL;?>">
  <div class="row gutters">
    <div class="columns screen-60 tablet-50 mobile-100 phone-100">
      <h2 class="underlined"><?php echo Lang::$word->_MOD_DS_SUB7;?></h2>
      <?php if(!$this->rows):?>
      ...
      <div class="wojo basic card">
        <div class="row">
          <div class="columns flex fcolumn auto screen-30 phone-100"><img src="<?php echo Digishop::hasThumb($row->thumb, $row->pid);?>" alt="" class="wojo rounded fit image"></div>
    ...
    <div class="columns screen-40 tablet-50 mobile-100 phone-100">
      <h2 class="underlined"><?php echo Lang::$word->_MOD_DS_SUB8;?></h2>
      <?php if($this->rows):?>
