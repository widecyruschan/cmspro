  ...
  <div class="row align middle">
    ...
    <div class="columns phone-100">
      <div class="full padding">
        <h6><a href="<?php echo Url::url(Router::$path, $row->slug);?>" class="secondary">
          <?php echo $row->title;?></a>
        </h6>
        <span class="wojo small text">
        <a href="<?php echo Url::url(Router::$path . '/' . $this->core->modname['portfolio-cat'], $row->cslug);?>" class="secondary"><?php echo $row->ctitle;?></a>
        </span>
      </div>
    </div>
  </div>
