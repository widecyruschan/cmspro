...
<div class="wojo-grid">
  ...
  <div class="vertical margin">
    <h2 class="underlined"><?php echo $this->row->{'name' . Lang::$lang};?></h2>
      ...
      <div class="wojo basic card">
        <figure class="wojo hover">
          ...
          <figcaption class="center aligned">
            <a href="<?php echo Url::url('/' . $this->core->modname['portfolio'], $row->slug);?>" class="black"><?php echo $row->title;?></a>
          </figcaption>
        </figure>
      </div>
    </div>
  ...
  <div class="row big gutters">
    <div class="columns screen-50 tablet-60 mobile-100 phone-100">
      <figure class="wojo hover">
        ...
        <figcaption class="center aligned">
          <a href="<?php echo FMODULEURL . Portfolio::PORTDATA . $this->row->id. '/' . $this->row->thumb;?>" class="wojo big circular primary icon button lightbox"><i class="icon url alt"></i></a>
        </figcaption>
      </figure>
      <?php if($this->images):?>
      ...
      <div class="wojo native sticky">
        ...
        <div class="wojo small relaxed fluid list">
          <div class="item">
            ...
            <div class="content wojo text"><?php echo $this->row->client;?></div>
          </div>
          <?php echo $this->custom_fields;?>
          <div class="item">
            <div class="content wojo semi text text screen-20"><?php echo Lang::$word->DATE;?></div>
            <div class="content wojo text"><?php echo Date::doDate("short_date", $this->row->created);?></div>
          </div>
...
<!-- Start default -->
<?php default: ?>
<?php if(App::Portfolio()->show_sort):?>
<!-- Sorting -->
...
<div class="vertical margin center aligned">
  <div class="wojo divided horizontal list">
    <a href="<?php echo Url::url(Router::$path);?>" class="wojo semi text item active">
    <?php echo Lang::$word->ALL;?>
    </a>
    <?php foreach($this->categories as $crow):?>
    <a href="<?php echo Url::url(Router::$path . '/' . $this->core->modname['portfolio-cat'], $crow->{'slug' . Lang::$lang});?>" class="item">
    <?php echo $crow->{'name' . Lang::$lang};?>
    </a>
    <?php endforeach;?>
  </div>
