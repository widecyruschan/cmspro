<?php
   ...
   * @copyright 2020
   * @version $Id: loadComment.tpl.php, v1.00 2020-01-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<?php
	if ($this->data->uname) {
		...
		$avatar = '<div class="wojo image avatar"><img src="' . UPLOADURL . '/avatars/blank.svg" alt=""></div>';
	} else {
		...
		$avatar = '<a href="' . $profile . '" class="wojo image avatar"><img src="' . UPLOADURL . '/avatars/' . ($this->data->avatar ? $this->data->avatar  : "blank.svg") . '" alt=""></a>';
	}
?>
