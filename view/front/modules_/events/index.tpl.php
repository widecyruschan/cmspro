...
<div class="center aligned">
  <h1 class="divided"><?php echo Lang::$word->_MOD_EM_TITLE3;?></h1>
  <p class="wojo primary inverted label"><?php echo str_replace("[YEAR]", Date::doDate("yyyy", Date::today()), Lang::$word->_MOD_EM_SUB3);?></p>
</div>
...
<div class="wojo divided feed">
  ...
  <div class="wojo event">
    <div class="label">
      <div class="wojo attached card basic center aligned" style="background:<?php echo $row->color;?>;color:#fff;opacity:.8">
