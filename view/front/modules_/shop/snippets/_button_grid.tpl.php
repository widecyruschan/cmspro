<?php
   ...
   * @copyright 2020
   * @version $Id: _button_grid.tpl.php, v1.00 2020-07-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<?php if ($row->quantity == 0 or $row->label == "sold" or $row->label == "soon"):?>
<a data-id="<?php echo $row->id;?>" class="wojo rounded secondary small button add-shop-wish" data-layout="grid">
...
<?php if(!$this->conf->catalog):?>
  ...
  <?php endif;?>
<?php endif;?>
<a data-id="<?php echo $row->id;?>" class="wojo top right attached icon circular secondary simple button add-shop-wish" data-tooltip="<?php echo Lang::$word->_MOD_SP_WISH;?>">
