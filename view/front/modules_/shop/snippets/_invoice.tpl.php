<?php
   ...
   * @copyright 2020
   * @version $Id: invoice.tpl.php, v1.00 2020-07-02 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<table border="0">
  <tr>
    <td style="width: 60%;" valign="top"><?php if ($this->core->plogo):?>
      ...
      <?php endif;?></td>
    <td valign="top" style="width:40%;text-align: right"><h4 style="margin:0px;padding:0px;font-size: 12px;">Invoice: #<?php echo $this->totals->invid;?></h4>
      <h4 style="margin:0px;padding:0px;font-size: 12px;"><?php echo Date::doDate("short_date", $this->totals->created);?></h4></td>
  </tr>
</table>
...
<table style="padding-top:25px">
  ...
  <tr>
    ...
    <td colspan="2" valign="top" style="width:40%"><p><?php echo $this->shipping->address;?></p></td>
  </tr>
  <tr>
    <td valign="top" style="width:60%"><br /></td>
    <td valign="top" style="width:20%">Amount Due:<br />
      Due Date:</td>
    <td valign="top" style="width:20%"><?php echo Utility::formatMoney($this->shipping->total, $this->totals->currency);?><br />
      <?php echo Date::dodate("short_date", $this->totals->created);?></td>
  </tr>
</table>
...
<table class="inventory">
  ...
  <tbody>
    ...
    <tr>
      <td>(x<?php echo $row->items;?>) <?php echo $row->title;?></td>
      <td class="right"><span><?php echo ($row->amount * $row->items);?></span></td>
    </tr>
    <?php endforeach;?>
  </tbody>
</table>
<table class="balance">
  <tr>
    ...
    <td><span><?php echo Utility::formatNumber($this->totals->sub);?></span></td>
  </tr>
  <tr>
    <th><span>Shipping</span></th>
    <td><span><?php echo Utility::formatNumber($this->shipping->shipping);?></span></td>
  </tr>
  <tr>
    <th><span>Taxes</span></th>
    <td><span><?php echo Utility::formatNumber($this->totals->tax);?></span></td>
  </tr>
  <tr>
    <th><span>Grand Total</span></th>
    <td><span><?php echo Utility::formatMoney($this->shipping->total, $this->totals->currency);?></span></td>
  </tr>
  <tr>
    <th>Status</th>
