<?php
   ...
   * @copyright 2018
   * @version $Id: _layout_single_right.php, v1.00 2018-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row gutters align middle">
  ...
  <div class="columns screen-50 tablet-100 mobile-100 phone-100">
    ...
    <a href="<?php echo FMODULEURL . Blog::BLOGDATA . $this->row->id. '/' . $this->row->thumb;?>" class="wojo basic rounded image lightbox">
      <img src="<?php echo Blog::hasThumb($this->row->thumb, $this->row->id);?>" data-title="<?php echo $this->row->caption;?>" alt="<?php echo $this->row->{'title' . Lang::$lang};?>">
    </a>
    <?php endif;?>
  </div>
</div>
