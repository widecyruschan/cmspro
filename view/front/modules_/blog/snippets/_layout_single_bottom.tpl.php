<?php
   ...
   * @copyright 2020
   * @version $Id: _layout_single_bottom.tpl.php, v1.00 2020-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="wojo horizontal relaxed divided list">
  ...
  <div class="item">
    <span class="wojo semi text intro"><?php echo Lang::$word->BY;?>:</span>
  ...
  <?php endif;?>
  <div class="item">
    <span class="wojo semi text intro"><?php echo Lang::$word->IN;?>:</span>
  ...
  <div class="item">
    <span class="wojo semi text description"><?php echo Lang::$word->_MOD_AM_SUB44;?>:</span>
