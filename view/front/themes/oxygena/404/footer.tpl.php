...
<footer>
  <div class="wojo-grid">
    <div class="vertical padding">
      <div class="row">
        <div class="columns phone-100"><span class="wojo small secondary text">&copy; <?php echo date('Y') . ' '. $this->core->company;?> | Powered by <a href="http://tag.digital" target="_blank">tag.digital Limited</a></div>
