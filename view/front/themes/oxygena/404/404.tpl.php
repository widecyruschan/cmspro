<?php
   ...
   * @copyright 2018
   * @version $Id: 404.tpl.php, v1.00 2018-10-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<main class="align middle">
  <div class="columns">
    ...
    <h1 class="wojo primary text"><?php echo Lang::$word->META_ERROR;?></h1>
    ...
    <a href="<?php echo SITEURL;?>/" class="wojo primary basic wide button"><i class="icon chevron left"></i>Go Back</a>
  </div>
</main>