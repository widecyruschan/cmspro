...
<div class="wojo simple fluid tabs">
  <ul class="nav">
    <li class="active">
      <a data-tab="tab_popular"><?php echo Lang::$word->_MOD_AM_SUB41;?></a>
    </li>
    <li>
      <a data-tab="tab_archive"><?php echo Lang::$word->_MOD_AM_SUB42;?></a>
    </li>
    <li>
  ...
  <div class="wojo segment tab">
      ...
      <div class="wojo very relaxed divided fluid list">
        ...
        <div class="item align middle">
          <figure class="wojo small basic rounded image">
            <img src="<?php echo Blog::hasThumb($poprow->thumb, $poprow->id);?>" alt="<?php echo $poprow->title;?>"></figure>
          <div class="content">
            <a href="<?php echo Url::url('/' . App::Core()->modname['blog'], $poprow->slug);?>" class="black"><?php echo $poprow->title;?></a>
          </div>
        </div>
        <?php endforeach;?>
      </div>
      ...
      <div class="wojo very relaxed divided fluid list">
        ...
        <div class="item align middle">
          <div class="content">
            ...
            <a href="<?php echo Url::url('/' . App::Core()->modname['blog'] . '/' . App::Core()->modname['blog-archive'], $arow->year . '-'. $arow->month);?>" class="black"><?php echo Date::doDate("MMMM yyyy", $arow->year . "-" . $arow->month);?></a>
          </div>
        </div>
        <?php endforeach;?>
      </div>
    ...
    <div class="item" data-tab="tab_comments">
      ...
      <div class="wojo relaxed divided fluid list">
        ...
        <div class="item">
          <div class="content">
            <a href="<?php echo Url::url('/' . App::Core()->modname['blog'], $comrow->slug);?>" class="black"><?php echo $comrow->title;?></a>
            </h6>
