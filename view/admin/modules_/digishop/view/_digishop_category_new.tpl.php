<?php
   ...
   * @copyright 2020
   * @version $Id: _digishop_category_new.tpl.php, v1.00 2020-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<form method="post" id="wojo_form" name="wojo_form">
  ...
  <div class="center aligned">
    ...
    <button type="button" data-url="modules_/digishop" data-action="processCategory" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->_MOD_DS_NEWCAT;?></button>
  </div>
</form>
