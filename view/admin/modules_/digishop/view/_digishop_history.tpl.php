<?php
   ...
   * @copyright 2020
   * @version $Id: _digishop_list.tpl.php, v1.00 2020-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
...
<div class="row gutters align middle">
  <div class="columns">
    <h3><?php echo Lang::$word->_MOD_DS_META_T1;?>
      <small>// <?php echo $this->data->{'title' . Lang::$lang};?></small></h3>
  </div>
  <div class="column auto"><a href="<?php echo AMODULEURL . 'digishop/controller.php?action=itemPayments&amp;id=' . $this->data->id;?>" class="wojo small dark stacked button"><i class="icon wysiwyg table"></i><?php echo Lang::$word->EXPORT;?></a>
  </div>
</div>
...
<div class="wojo segment">
  <table class="wojo responsive basic table">
    ...
    <tr>
      ...
      <td class="auto" data-sort-value="<?php echo strtotime($row->created);?>"><?php echo Date::doDate("short_date", $row->created);?></td>
    </tr>
    <?php endforeach;?>
  </table>
  <div class="wojo small passive primary inverted button"><?php echo Lang::$word->TRX_TOTAMT;?>
