...
?>
<h2 class="header"><?php echo Lang::$word->_MOD_FAQ_SUB2;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  ...
  <div class="center aligned">
    ...
    <button type="button" data-url="modules_/faq" data-action="processCategory" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->_MOD_FAQ_SUB2;?></button>
  </div>
</form>
