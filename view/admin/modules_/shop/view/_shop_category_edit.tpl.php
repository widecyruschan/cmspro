<?php
   ...
   * @copyright 2020
   * @version $Id: _shop_category_edit.tpl.php, v1.00 2020-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<h2 class="header"><?php echo Lang::$word->_MOD_SP_META_T4;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  ...
  <div class="center aligned">
    <a href="<?php echo Url::url("/admin/modules/shop/categories");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-url="modules_/shop" data-action="processCategory" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->_MOD_DS_UPDATECAT;?></button>
  </div>
