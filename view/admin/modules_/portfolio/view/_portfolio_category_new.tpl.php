<?php
   ...
   * @copyright 2020
   * @version $Id: _portfolio_category_new.tpl.php, v1.00 2020-01-08 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<h2 class="header"><?php echo Lang::$word->_MOD_PF_NEWCAT;?></h2>
<form method="post" id="wojo_form" name="wojo_form">
  ...
  <div class="center aligned">
    ...
    <button type="button" data-url="modules_/portfolio" data-action="processCategory" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->_MOD_PF_NEWCAT;?></button>
  </div>
</form>
