<?php
   ...
   * @copyright 2020
   * @version $Id: Adblock.class.php, v5.00 2020-03-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  class Adblock
  {
      ...
      {
          $rules = array(
              'start_date_submit' => array('required|date', Lang::$word->_MOD_AB_SUB10),
              'end_date_submit' => array('required|date', Lang::$word->_MOD_AB_SUB11),
      ...
      public function _updateCampaign($rules, $filters)
      {
          ...
          if (empty(Message::$msgs)) {
              ...
              $datax = array(
                  'start_date' => Db::toDate($safe->start_date_submit, false),
                  'end_date' => Db::toDate($safe->end_date_submit, false),
