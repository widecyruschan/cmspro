...
<form method="post" id="wojo_form" name="wojo_form">
        ...
        <div class="row grid phone-1 tablet-2 tablet-4 screen-4 gutters" id="layoutMode">
          <div class="columns">
            <div class="wojo simple attached segment center aligned <?php Validator::getActive($this->data->layout, 1); ?>">
              <a data-type="1" class="wojo normal basic image"><img src="<?php echo AMODULEURL;?>blog/view/images/list.svg" alt=""></a>
            </div>
          </div>
          <div class="columns">
            <div class="wojo simple attached segment center aligned <?php Validator::getActive($this->data->layout, 2); ?>">
              <a data-type="2" class="wojo normal basic image"><img src="<?php echo AMODULEURL;?>blog/view/images/modern.svg" alt=""></a>
            </div>
          </div>
          <div class="columns">
            <div class="wojo simple attached segment center aligned <?php Validator::getActive($this->data->layout, 3); ?>">
              <a data-type="3" class="wojo normal basic image"><img src="<?php echo AMODULEURL;?>blog/view/images/masonry.svg" alt=""></a>
            </div>
          </div>
          <div class="columns">
            <div class="wojo simple attached segment center aligned <?php Validator::getActive($this->data->layout, 4); ?>">
              <a data-type="4" class="wojo normal basic image"><img src="<?php echo AMODULEURL;?>blog/view/images/classic.svg" alt=""></a>
            </div>
          </div>
        </div>
  ...
  <div class="center aligned">
    <a href="<?php echo Url::url("/admin/modules/blog/categories");?>" class="wojo simple small button"><?php echo Lang::$word->CANCEL;?></a>
    <button type="button" data-url="modules_/blog" data-action="processCategory" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->_MOD_AM_UPDATECAT;?></button>
  </div>
