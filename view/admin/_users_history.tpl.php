...
<div class="wojo segment">
  <div class="row gutters align middle">
    ...
    <div class="columns auto phone-100"><a href="<?php echo ADMINVIEW . '/helper.php?action=exportUserPayments&amp;id=' . $this->data->id;?>" class="wojo dark small button"><i class="icon wysiwyg table"></i><?php echo Lang::$word->EXPORT;?></a></div>
  </div>
    ...
    <div class="wojo tab">
      <div data-tab="mem" class="item">
        <table class="wojo responsive basic table">
          ...
          <tr>
            <td><a href="<?php echo Url::url("/admin/memberships/edit", $mrow->mid);?>"><?php echo $mrow->title;?></a></td>
      ...
      <div data-tab="pay" class="item">
        ...
        <a class="wojo small simple passive button"><?php echo Lang::$word->TRX_TOTAMT;?>
        <?php echo Utility::formatMoney(Stats::doArraySum($this->plist, "total"));?></a>
      </div>
    </div>
  </div>
</div>
