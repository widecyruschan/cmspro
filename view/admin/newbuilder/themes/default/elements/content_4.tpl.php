        ...
        <div data-weditable="true">
          <div class="wojo very relaxed fluid list">
            <div class="item">
              ...
              <div class="content">
                <h4 class="wojo primary text">Easy & fast designing</h4>
                <div class="description">Start knowing what your attendees value, and win more business with CMS Pro.</div>
              </div>
            </div>
            <div class="item">
              <i class="icon large secondary storage" data-type="icon"></i>
              <div class="content">
                <h4 class="wojo primary text">Powerful features</h4>
                <div class="description">Easily draft, change, customize and launch new course pages with an easy-to-use template.</div>
              </div>
            </div>
          </div>
          <div class="margin top">
            <a href="#" class="wojo rounded primary right button" data-type="button">Get started <i class="icon chevron right"></i></a>
          </div>
        </div>
      </div>
      <div class="columns screen-50 tablet-50 mobile-100 phone-100">
