<div class="section relative" style="background-image: linear-gradient(150deg, #6442ff 0%, #1B1464 100%);background-repeat: repeat-x;padding:196px 0 196px 0">
  <div class="wojo-grid">
    <div class="row gutters">
      <div class="columns screen-50 tablet-50 mobile-100 phone-100">
        <div data-weditable="true">
          <h2 class="wojo white text">You wish us<br>
            to talk about <span class="wojo semi text">your project?</span></h2>
          <a class="wojo large inverted text" href="mailto:support@wojoscripts.com">support@wojoscripts.com</a>
        </div>
      </div>
      <div class="columns screen-50 tablet-50 mobile-100 phone-100 right aligned self align bottom">
        <div class="wojo relaxed horizontal list" data-weditable="true">
          <a class="item white" href="#">
        ...
        <div class="margin top"><span class="wojo large dimmed white text" data-weditable="true">+1 (416) 109-9222</span></div>
      </div>
    </div>
  </div>
