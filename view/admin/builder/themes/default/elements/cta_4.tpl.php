<div class="section relative" style="background-image: linear-gradient(150deg, #2d1582 0%, #19a0ff 100%);padding:64px 0">
  <div class="wojo-grid">
    <div class="row align middle">
      <div class="columns">
        <div class="wojo white text center aligned" data-weditable="true">
          <h3 class="wojo semi warning text bottom margin">Ready to get started?</h3>
