...
<div class="wojo form segment">
  <form method="get" id="wojo_form" action="<?php echo Url::url(Router::$path);?>" name="wojo_form">
    <div class="row align center middle gutters">
      ...
      <div class="columns auto phone-hide">
        <a href="<?php echo ADMINVIEW;?>/helper.php?action=exportAllTransactions<?php echo Url::query();?>" class="wojo primary icon button"><i class="icon wysiwyg table"></i></a>
      </div>
    </div>
  </form>
  <?php if($this->data):?>
  <table class="wojo responsive basic table">
    ...
    <tr id="item_<?php echo $row->id;?>">
      <td class="auto"><span class="wojo small dark inverted labe"><?php echo $row->id;?></span></td>
  ...
  <div class="wojo small secondary passive button"><?php echo Lang::$word->TRX_TOTAMT;?>
