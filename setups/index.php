...
<?php
  if (!file_exists("../lib/config.ini.php")) {
      ...
      die("<div style='text-align:center'>" 
		  ...
		  . "font-family: Verdana; font-size: 11px; margin-left:auto; margin-right:auto; display:inline-block'>" 
		  . "<b>Attention:</b> The file config.ini.php already exists!<br>If you want to reinstall CMS pro you must first delete the config.ini.php located in /lib/ folder</span></div>");
  }
?>