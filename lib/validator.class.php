<?php
   ...
   * @copyright 2020
   * @version $Id: validator.class.php, v1.00 2020-01-20 18:20:24 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  class Validator
  {
      ...
      public static $advanced_tags =
          '<iframe><body><html><section><article><video><audio><source><div><table><td><tr><th><tbody><thead><img><svg><figure><br><p><a><strong><u><b><i><em><img><pre><blockquote><code><dd><dl><hr><h1><h2><h3><h4><h5><h6><label><ol><ul><li><span><sub><sup><button><defs><path><clipPath><use><image><style><ellipse><circle><g><polyline><line><rect><polygon><form><input><select><option>';
      ...
      public static function sanitize($data, $type = 'default', $trim = false)
      {
          switch ($type) {
              ...
              case "chars":
			  case "spchar":
                  return htmlspecialchars(str_replace(array('\'', '"'), '', $data), ENT_QUOTES, 'UTF-8');
                  break;
              ...
              case "default":
                  ...
                  $data = str_replace(array(
                      ...
                      '"'), $data);
                  if ($trim)
                      //$data = mb_substr($data, 0, $trim);
					  $data = self::truncate($data, $trim);
                  return $data;
                  break;
          }
      }
