<?php
  ...
  class Stats
  {
      ...
      public static function getAllStats()
      {
		  ...
		  $enddate = (Validator::get('enddate_submit') && $_GET['enddate_submit'] <> "") ? Validator::sanitize(Db::toDate($_GET['enddate_submit'], false)) : date("Y-m-d");
		  $fromdate = Validator::get('fromdate_submit') ? Validator::sanitize(Db::toDate($_GET['fromdate_submit'], false)) : null;
       ...
       * @return
       */
      public static function exportAllTransactions($fromdate = '', $enddate = '')
      {
