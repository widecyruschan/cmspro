<?php
   ...
   * @copyright 2020
   * @version $Id: image.class.php, v1.00 2020-03-05 10:12:05 gewa Exp $
   */
  ...
  class Image
  {
      ...
      protected function getMetaData()
      {
          ...
          $this->originalInfo = array(
              ...
              'height' => $info[1],
              'orientation' => $this->getOrientation(),
              'exif' => function_exists('exif_read_data') && $info['mime'] === 'image/jpeg' && isset($info["APP13"]) && $this->imagestring === null ? $this->exif = @exif_read_data($this->filename) : null,
